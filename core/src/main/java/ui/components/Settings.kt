package killua.dev.core.ui.components
...
import killua.dev.core.db.readStoreBoolean
import killua.dev.core.db.saveStoreBoolean
import killua.dev.core.killua.dev.core.killua.dev.core.ui.components.withState
import killua.dev.core.ui.animations.AnimatedTextContainer
import kotlinx.coroutines.launch
import ui.components.TitleLargeText
import ui.components.TitleSmallText
        ...
        Row(modifier = Modifier.height(IntrinsicSize.Min), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(SizeTokens.Level16)) {
            ...
            Column(modifier = Modifier.weight(1f)) {
                AnimatedTextContainer(targetState = title) { text ->
                    TitleLargeText(enabled = enabled, text = text, fontWeight = FontWeight.Normal)
                }
                if (value != null) AnimatedTextContainer(targetState = value) { text ->
                    TitleSmallText(enabled = enabled, text = text, fontWeight = FontWeight.Normal)
                }
            }
