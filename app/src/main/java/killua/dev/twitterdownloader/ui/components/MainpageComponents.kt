...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FavouriteCard(favouriteUser: String,favouriteUserScreenName: String,downloadCount:Int, onClick: ()-> Unit){
    OverviewCard(
        ...
        Dialog(
            ...
            Surface(
                ...
                Column(
                    ...
                    Spacer(modifier = Modifier.Companion.height(SizeTokens.Level16))
                    ...
                    Spacer(modifier = Modifier.Companion.height(SizeTokens.Level24))
                    ...
                    Row(
                        ...
                        Spacer(modifier = Modifier.Companion.width(SizeTokens.Level8))
